...
void display_instructions() {
    ...
    std::cout << "\n💡 TIPS:" << std::endl;
    std::cout << "• Plan your mana usage carefully" << std::endl;
    std::cout << "• Use creatures to control the board" << std::endl;
    std::cout << "• Save spells for crucial moments" << std::endl;
    std::cout << "• Watch for elemental advantages!" << std::endl;
